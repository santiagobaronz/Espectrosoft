		...
		<div>
			<div className='container bg-header w-full py-24 flex items-center'>
				<div className='w-2/4'>
					...
					<h1 className='text-[55px] leading-[1.10] font-semibold mb-5 mt-8'>{tsHomepage('title_s1')} <span className='text-blue'>{tsHomepage('title_s2')}</span> {tsHomepage('title_s3')} <span className='text-blue'>{tsHomepage('title_s4')}</span></h1>
					<p className='text-lg'>{tsHomepage('description')}</p>
					...
					<div className='flex items-center gap-x-16 mt-8'>
						<div>
							...
							<p className='text-sm text-gray mt-2'>{tsHomepage('join_community')}</p>
						</div>
