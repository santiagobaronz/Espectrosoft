	...
	return (
		<div className='mt-20'>
			...
			<div id="grid-decoration">
				<div className="absolute inset-x-0 z-0 top-[129px] h-[450px] rotate-180 text-gray opacity-20">
					<svg className="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
						<defs>
							<pattern id="grid-pattern" width="32" height="32" patternUnits="userSpaceOnUse" x="0%" y="100%"
								patternTransform="translate(0 -1)">
								<path d="M0 32V.5H32" fill="none" stroke="#BEBEBE"></path>
							</pattern>
						</defs>
			...
			<div className='container relative z-10'>
				<div className='bg-blue-bg md:px-8 px-4 py-2 mx-auto rounded-full max-md:text-sm text-gray-200 flex items-center gap-x-2 w-fit'>
					<BsFillGearFill></BsFillGearFill>
					<p>Transformamos ideas en tecnología</p>
				</div>
				<h1 className='text-6xl leading-[1.10] font-semibold mb-8 mt-8 text-center'>
					We build solutions for <span className='text-blue'>your business</span>
				</h1>
				<p className='w-3/6 mx-auto text-center text-lg mb-10'>Somos un equipo apasionado de expertos en desarrollo de software, dedicados a convertir tus ideas en soluciones tecnológicas innovadoras y exitosas.</p>
			</div>
			...
			<div className='mt-10'>
				...
				<div className='bg-blue-section py-28 bg-culture'>
					<div className='container text-white flex gap-x-10'>
						<div className='w-3/6'>
							<h2 className='text-3xl font-medium mb-14'>Nuestra cultura</h2>
							<div className="grid grid-cols-2 grid-rows-2 gap-x-20 gap-y-12 mb-16">
								<div>
						...
						<div className='w-3/6'>
							<img src="https://imgur.com/o3Uz7gu.jpg" alt="Imagen cultura empresarial" className='h-full w-full p-12 object-cover rounded-[70px]' />
						</div>
			...
			<div className='py-24 bg-[#F4F4F6] bg-stats'>
				<div className='container flex justify-between'>
					<div className='w-1/2'>
						<h2 className='font-bold text-4xl w-2/3'>We promote your growth together</h2>
						<p className='mt-6 w-5/6'>En Espectrosoft, nos dedicamos a transformar ideas en soluciones digitales innovadoras. Con una pasión por la tecnología y una profunda comprensión del panorama empresarial, nos especializamos en ofrecer aplicaciones web de vanguardia que impulsan la eficiencia y potencian el crecimiento.</p>

						<div className='flex justify-between mb-12 w-3/4 mt-10'>
							<img src="https://imgur.com/AMrRL7v.png" alt="" className='w-32' />
							<img src="https://imgur.com/jK9nBP7.png" alt="" className='w-32' />
							<img src="https://imgur.com/IfGNB61.png" alt="" className='w-32' />

						</div>
						<div className='flex gap-x-16'>
							<img src="https://imgur.com/mTK8J8D.png" alt="" className='w-32' />
							<img src="https://imgur.com/XkmbqVt.png" alt="" className='w-32' />
							<p className='text-gray ml-8 opacity-80'>10+ Alianzas</p>
						</div>
					</div>

					<div className='w-1/2'>
						<div className="grid grid-cols-2 grid-rows-3 gap-5">
							<div className='bg-white p-7 rounded-xl shadow-sm hover:translate-x-0.5 hover:-translate-y-0.5 transition-all hover:shadow-lg'>
							...
							<div className="row-start-2 bg-white p-7 rounded-xl shadow-sm hover:translate-x-0.5 hover:-translate-y-0.5 transition-all hover:shadow-lg">
							...
							<div className="row-start-3 bg-white p-7 rounded-xl shadow-sm hover:translate-x-0.5 hover:-translate-y-0.5 transition-all hover:shadow-lg">
