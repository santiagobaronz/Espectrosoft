	...
	return (
		<div className='mt-20'>
			<div className='container relative z-10 max-lg:px-10'>
				...
				Creamos soluciones para <span className='text-blue'>tu negocio</span>
				</h1>
						...
						<div className='lg:w-3/6'>
							...
							<div className="md:grid grid-cols-2 grid-rows-2 gap-x-20 gap-y-12 mb-16">
								<div className=' max-md:mb-16'>
									...
									<h3 className='mt-5 font-medium mb-3'>Calidad excepcional</h3>
									<p className='font-light'>Creamos software excepcional, siempre superando expectativas con un rendimiento confiable y un diseño impecable.</p>
								</div>
								<div className=' max-md:mb-16'>
									<div className='bg-[#233442] w-fit p-3 rounded'>
									...
									<p className='font-light'>Siempre en busca de lo nuevo, exploramos tecnologías y enfoques innovadores para ofrecerte soluciones de vanguardia.</p>
								</div>
								<div className="row-start-2 mt-5 max-md:mb-16">
									...
									<p className='font-light'>Trabajamos juntos para obtener resultados sobresalientes, fusionando nuestras habilidades y conocimientos.</p>
								</div>
								<div className="row-start-2 mt-5 max-md:mb-16">
									<div className='bg-[#233442] w-fit p-3 rounded'>
			...
			<div className='mt-16 py-24 bg-[#F4F4F6] bg-stats'>
				<div className='container lg:flex justify-between max-lg:px-10'>
					<div className='lg:w-1/2'>
						<h2 className='font-bold text-4xl lg:w-2/3'>Impulsamos tu crecimiento en internet juntos</h2>
						<p className='mt-6 lg:w-5/6'>En Espectrosoft, nos dedicamos a transformar ideas en soluciones digitales innovadoras. Con pasión por la tecnología y una comprensión profunda del panorama empresarial, nos especializamos en ofrecer aplicaciones web de vanguardia que impulsan la eficiencia y potencian el crecimiento.</p>
