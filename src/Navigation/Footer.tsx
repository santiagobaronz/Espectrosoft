					...
					<div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>
								...
								<ul role="list" className="mt-4 space-y-4">
									...
									<li>
										<Link href="#" className="text-base text-gray-500 hover:text-gray-900">Alojamiento web</Link>
									</li>
								</ul>
							</div>
							<div className="mt-12 md:mt-0"><h3 className="text-base font-medium text-gray-900">Soporte</h3>
								<ul role="list" className="mt-4 space-y-4">
									<li>
										<Link href="mailto:hello@praisehive.com" className="text-base text-gray-500 hover:text-gray-900">Contacto</Link>
									</li>
									<li>
						...
						<div className="md:grid md:grid-cols-2 md:gap-8"><div>
							...
							<ul role="list" className="mt-4 space-y-4">
								...
								<li>
									<Link href="/guides" className="text-base text-gray-500 hover:text-gray-900">Guides</Link>
								</li>
							</ul>
						</div>
							<div className="mt-12 md:mt-0">
								...
								<ul role="list" className="mt-4 space-y-4">
									<li>
										<Link href="/privacy-policy" className="text-base text-gray-500 hover:text-gray-900">Política de privacidad</Link>
									</li>
									<li>
										<Link href="#" className="text-base text-gray-500 hover:text-gray-900">Términos del servicio</Link>
									</li>
								</ul>
							</div>
						</div>
